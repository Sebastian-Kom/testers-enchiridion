# V103 publication checks

Prepared 22 September 2026.

## Completed

- All 52 chapters are present, in order, in the manuscript, map, web reader, and PDF.
- The map's chapter titles and text match the canonical manuscript.
- Every chapter is reachable through the concept map, and testing-concept links agree in both directions.
- The intended retained passages appear in their chapters; adaptations and the omission in §40 are documented.
- JavaScript syntax, chapter selection, switching to source passages, related-concept navigation, and invalid selection handling were checked.
- All local links in the three generated HTML pages resolve within the published folder.
